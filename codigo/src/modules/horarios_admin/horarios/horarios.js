...
await db.collection("consultas").where("profissional", "==", loggedUser.user.uid).get().then(response =>{
...
btnIniciar.addEventListener('click', () => {
    ...
    if(inputRadio) {
        window.location.replace(`/codigo/src/modules/visualiza_documentos/index.html?consulta=${consultaId}`);
    } else {
